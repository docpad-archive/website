...
var appPath, contributorGetter, docpadConfig, extendr, fsUtil, getCategoryName, getLabelName, getLinkName, getName, getProjectName, humanize, moment, navigationData, pathUtil, rootPath, safeps, sitePath, siteUrl, strUtil, textData, websiteVersion,
...
docpadConfig = {
  ...
  events: {
    extendTemplateData: function(opts, next) {
      ...
      contributorGetter.fetchContributorsFromUsers(['bevry', 'docpad'], function(err, contributors) {
        if (err) {
          return next(err);
        }
